...
+ [**Następne zadanie**: Create continuous build integration using Oracle Developer Cloud Service and Oracle Application Container Cloud Service](devcs.accs.ci.md)
